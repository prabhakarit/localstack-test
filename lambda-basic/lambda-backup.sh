...
RESOURCE_ID=$(awslocal apigateway get-resources --rest-api-id ${API_ID} --query 'items[?path==`/restapis`].id' --output text --region ${REGION})
...
ENDPOINT=http://0.0.0.0:4566/restapis/${API_ID}/${STAGE}/_user_request_/HowMuchIsTheFish
